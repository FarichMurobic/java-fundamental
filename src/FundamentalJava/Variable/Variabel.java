 ...
 * Variabel
 * 
 * Variabel adalah unit dasar penyimpanan dalam program Java. Variabel didefinisikan oleh:
 ...
 * Semua variabel harus dideklarasikan sebelum digunakan. Lo bisa mendeklarasikan beberapa
 * variabel sekaligus dengan tipe yang sama menggunakan koma. Inisialisasi bisa dilakukan secara
...
public class Variabel {
    ...
    public static void main(String[] args) {
         ...
         *
         * Di Java, variabel harus dideklarasikan dengan tipe data sebelum digunakan. Format umumnya:
         ...
         * -Kata-kata yang dicadangkan (seperti kata kunci Java, seperti int atau boolean) tidak dapat digunakan sebagai nama variabel
         */
        ...
        // Di sini, nilai double3 dihitung menggunakan hasil dari ekspresi Math.sqrt(...), bukan nilai konstan.
         ...
         * 
         * Dalam Java, lingkup (scope) didefinisikan oleh blok kode, yaitu area di antara kurung kurawal
         * { dan }. Lingkup menentukan visibilitas dan masa hidup variabel.
         *
         * Aturan Penting tentang Lingkup:
         * 1.	Variabel Lokal: Variabel yang dideklarasikan di dalam sebuah blok hanya terlihat
         *      dan dapat diakses di dalam blok itu saja.
         * 2.	Lingkup Bersarang: Lingkup bisa bersarang. Variabel yang dideklarasikan di lingkup luar (outer scope)
         *      dapat diakses oleh kode di lingkup dalam (inner scope), tetapi tidak sebaliknya.
         * 3.	Masa Hidup: Variabel diciptakan saat lingkupnya dimasuki dan dihancurkan saat lingkupnya ditinggalkan.
         *      Ini berarti nilai variabel tidak akan bertahan jika lingkupnya berakhir.
         * 4.	Inisialisasi Ulang: Jika sebuah variabel diinisialisasi di dalam sebuah blok,
         *      ia akan diinisialisasi ulang setiap kali blok itu dimasuki.
         * 5.	Nama Variabel: Lo tidak bisa mendeklarasikan variabel dengan nama yang sama di lingkup dalam
        ...
        // Setiap kali for loop berulang, variabel y baru dibuat, diinisialisasi ke -1, dan setelah perulangan
        // selesai, y dihancurkan, sehingga nilainya tidak bertahan untuk iterasi berikutnya
