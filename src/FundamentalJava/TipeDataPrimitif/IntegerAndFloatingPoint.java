...
public class IntegerAndFloatingPoint {
     ...
     * 
     * Java memiliki empat tipe data integer, semuanya bertanda (signed) yang
     * berarti bisa
     * menyimpan nilai positif dan negatif. Java tidak memiliki tipe data integer
     ...
     * 4, Long -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807 8 bytes (64
     * bits)
     *
     * Untuk membuat literal long, lo harus menambahkan L atau l di akhir angka,
     * misalnya 9223372036854775807L
     *
     * Secara default, setiap nilai bilangan bulat adalah literal int (32-bit). Lo
     * bisa menuliskannya dalam berbagai basis:
     *
     * 1. Desimal (basis 10): Contohnya 10, 42.
     * 2. Oktal (basis 8): Ditandai dengan awalan 0 (nol). Contoh: 010 (sama dengan
     * 8 dalam desimal).
     ...
     * 4. Biner (basis 2): Ditambahkan sejak JDK 7. Ditandai dengan awalan 0b atau
     * 0B.
    ...
    public static void main(String[] args) {
        ...
        // int, Tipe integer yang paling sering digunakan. Sangat ideal untuk penghitung
        // loop.
        ...
        // long, Digunakan saat int tidak cukup besar, seperti pada perhitungan jarak
        // cahaya.
        ...
        /**
         * Oktal (basis 8): Ditandai dengan awalan 0 (nol). Contoh: 010 (sama dengan 8
         * dalam desimal).
         * Angka 8 dan 9 tidak diizinkan dalam format ini.
         * digit 0-7
        ...
        // int heksaDesimal4 = 0xg; // akan error, karena g bukan digit valid
        // heksadesimal (maksimum F)
        ...
        /**
         * Biner (basis 2): Ditambahkan sejak JDK 7. Ditandai dengan awalan 0b atau 0B.
         * Contoh:
         ...
         * mungkin byte dan short bisa kalau nilai dari hexa dan biner mencakup
         * kapasitasnya.
         */
        ...
        // float, Presisi tunggal, lebih kecil. Cocok untuk data yang tidak memerlukan
        // akurasi tinggi.
        float iniFloat = 10.10F; // Note diakhiri huruf F untuk setiap Float
        System.out.println("Ini float: " + iniFloat);
        System.out.println(
                "Kapasitas Float: float Stores fractional numbers. Sufficient for storing 6 to 7 decimal digits");

        // double, Presisi ganda, lebih akurat. Ini adalah pilihan default untuk
        // perhitungan matematis kompleks.
        double iniDouble = 10.10;
        System.out.println("Ini double: " + iniDouble);
        System.out
                .println("Kapasitas Double: Stores fractional numbers. Sufficient for storing 15 to 16 decimal digits");
