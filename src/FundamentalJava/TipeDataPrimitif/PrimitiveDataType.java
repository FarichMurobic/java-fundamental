...
public class PrimitiveDataType {
     ...
     * dan semua penugasan (assignment) harus kompatibel. Kompilator Java akan
     * memeriksa semua ini,
     ...
     *
     * Tipe primitif ini bukan objek, melainkan nilai tunggal. Ini dilakukan untuk
     * efisiensi performa.
     */

    public static void main(String[] args) {

        // Primitive Types, Tipe data merepresentasikan sesuai proporsinya
        // masing-masing!
        byte thisByte = 10;
