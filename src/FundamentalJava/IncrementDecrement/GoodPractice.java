...
public class GoodPractice {
    public static void main(String[] args) {
        ...
        System.out.println("Jika j = 65, k = 10, lalu i = (++j) * k; -> i = " + i + ", j = " + j); // Output: i=660,
                                                                                                   // j=66

        // Contoh 2.29 - Baris 2: i = (j++) * k;
        j = 65; // Reset j
        i = (j++) * k; // Nilai j (65) digunakan DULU untuk perkalian (65 * 10 = 650), baru j
                       // di-increment (jadi 66). 650 ditugaskan ke i
        System.out.println("Jika j = 65, k = 10, lalu i = (j++) * k; -> i = " + i + ", j = " + j); // Output: i=650,
                                                                                                   // j=66

        // Contoh 2.29 - Baris 3: i = (--j) * k;
        j = 65; // Reset j
        i = (--j) * k; // j di-decrement DULU (jadi 64), lalu 64 * 10 = 640. 640 ditugaskan ke i
        System.out.println("Jika j = 65, k = 10, lalu i = (--j) * k; -> i = " + i + ", j = " + j); // Output: i=640,
                                                                                                   // j=64

        // Contoh 2.29 - Baris 4: i = (j--) * k;
        j = 65; // Reset j
        i = (j--) * k; // Nilai j (65) digunakan DULU untuk perkalian (65 * 10 = 650), baru j
                       // di-decrement (jadi 64). 650 ditugaskan ke i
        System.out.println("Jika j = 65, k = 10, lalu i = (j--) * k; -> i = " + i + ", j = " + j); // Output: i=650,
                                                                                                   // j=64
