...
public class ExplicitCasting {
    public static void main(String[] args) {
        ...
        System.out.println("(double)(151/2) hasilnya: " + (double) (151 / 2)); // 151/2 (int div) = 75, lalu (double)75
                                                                               // = 75.0
        System.out.println("\n");
        ...
        System.out.println("(int)(c) + (int)(d) hasilnya: " + ((int) (c) + (int) (d))); // (int)4.25=4, (int)5.80=5.
                                                                                        // Lalu 4+5=9
        System.out.println("(int)(c + d) hasilnya: " + (int) (c + d)); // (4.25+5.80)=10.05, lalu di-cast jadi 10
        System.out.println("(double)(a/b) + c hasilnya: " + ((double) (a / b) + c)); // (7/10)=0 (int), lalu di-cast
                                                                                     // jadi 0.0. Lalu 0.0 + 4.25 = 4.25
        System.out.println("(double)(a)/b + d hasilnya: " + ((double) (a) / b + d)); // (double)7=7.0. Lalu 7.0/10
                                                                                     // (promosi 10 jadi 10.0) = 0.7.
                                                                                     // Lalu 0.7 + 5.80 = 6.50
        System.out.println("\n");
        ...
        System.out.println("'J' + '0' (tanpa cast eksplisit) hasilnya: " + ('J' + '0')); // Hasilnya tetap 122 karena
                                                                                         // promosi otomatis
        ...
        // False. Untuk String ke int/double, gunakan Integer.parseInt() atau
        // Double.parseDouble()
