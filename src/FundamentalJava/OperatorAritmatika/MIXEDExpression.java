 ...
 * dari lebih dari satu tipe data numerik disebut ekspresi campuran (mixed
 * expression).
 * Jadi, ekspresi campuran bisa berisi nilai int dan long, atau int dan double,
 * dan sebagainya..
 *
 * Jika kedua operand memiliki tipe data yang sama, tidak ada yang perlu
 ...
 * untuk tujuan evaluasi ekspresi ini. Ini sering disebut sebagai "promosi" atau
 * "konversi implisit".
 *
 * Urutan konversi data adalah sebagai berikut (dari rentang terkecil ke
 * terbesar):
 * byte → short → int → long → float → double Atau kombinasi apa pun dari ini
...
public class MIXEDExpression {
    public static void main(String[] args) {
        ...
        /**
         * Jika satu operand adalah int dan yang lainnya adalah double, nilai data int
         * akan dipromosikan menjadi nilai double.
         * Dalam kasus ini, operasi floating point akan terjadi dan hasilnya akan
         * bertipe double.
         * Demikian pula, jika satu operand adalah int dan yang lainnya adalah long,
         * nilai data int akan dipromosikan menjadi nilai long.
        ...
        // 3. 2.4545454545454546 + 4 (double + int) -> int 4 dipromosikan jadi double
        // 4.0
        ...
        // 1. 353.35 - 0.001F (double - float) -> float 0.001F dipromosikan jadi double
        // 0.001
